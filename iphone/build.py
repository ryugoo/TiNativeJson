...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.r384ta.ti.module.tinativejson.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComR384taTiModuleTinativejsonModuleAssets.m')
